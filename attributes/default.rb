...
# Jenkins version
default['pw_jenkins']['master']['version'] = '2.11'
...
default['pw_jenkins']['master']['plugin_baseurl'] = 'https://updates.jenkins-ci.org/download/plugins/'
...
default['pw_jenkins']['master']['updatecenter'] = 'http://mirrors.jenkins-ci.org/updates/current/update-center.json'
default['pw_jenkins']['master']['source'] = "http://pkg.jenkins-ci.org/debian/binary/jenkins_#{node['pw_jenkins']['master']['version']}_all.deb"
...
default['pw_jenkins']['slave']['swarm_base_url'] = 'http://repo.jenkins-ci.org/releases/org/jenkins-ci/plugins/swarm-client/2.0/'
